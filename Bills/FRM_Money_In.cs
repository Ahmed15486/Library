...
{
    public partial class FRM_Money_In : Form
    {
        #region Declaration
        CLS_Money_In Money_In = new CLS_Money_In();
        Bills.FRM_Jor Jor;
        ...
        public FRM_Money_In(frm_Main main)
        {
            InitializeComponent();
            Main = main;
        ...
        private void var()
        {
            Money_In.Money_In_ID = (txt_Bill_ID.Text != "") ? txt_Bill_ID.Text : "";
            Money_In.Money_In_Date = dtp_Money_In_Date.Value;
            Money_In.Pay_Type = Convert.ToInt32(com_Pay_Type.SelectedValue);
            Money_In.ACC_ID = com_ACC_ID_From.SelectedValue.ToString();
            Money_In.Value = Convert.ToDecimal(txt_Value.Text);
            Money_In.Notes = txt_Notes.Text;
            Money_In.Branche_ID = combo_Bill_Branches.SelectedValue.ToString();
            Money_In.CC1_ID = Convert.ToInt32(combo_CC1.SelectedValue);
            Money_In.CC2_ID = Convert.ToInt32(combo_CC2.SelectedValue);
            Money_In.User_ID = Convert.ToInt32(combo_Bill_User.SelectedValue);
        ...
        private void Form_Mode(string mode)
        {
            switch (mode)
            {
                ...
                case "Select":
                    ...
                    dtp_Money_In_Date.Format = DateTimePickerFormat.Short;
                    ...
                    dtp_Money_In_Date.Enabled = false;
                    com_Pay_Type.Enabled = false;
                    txt_Value.ReadOnly = true;
                    com_ACC_ID_From.Enabled = false;
                    com_ACC_Name_Form.Enabled = false;
                    cbx_Cust.Enabled = false;
                ...
                case "New":
                    ...
                    txt_Value.Clear();
                    com_ACC_ID_From.SelectedValue = -1;
                    com_ACC_Name_Form.SelectedValue = -1;
                    txt_Notes.Clear();
                    dtp_Money_In_Date.Format = DateTimePickerFormat.Short;
                    ...
                    dtp_Money_In_Date.Enabled = true;
                    com_Pay_Type.Enabled = true;
                    txt_Value.ReadOnly = false;
                    com_ACC_ID_From.Enabled = true;
                    com_ACC_Name_Form.Enabled = true;
                    cbx_Cust.Enabled = true;
                ...
                case "Empty":
                    ...
                    //Clare Controls
                    txt_Bill_ID.Clear();
                    dtp_Money_In_Date.Format = DateTimePickerFormat.Custom;
                    txt_Notes.Clear();
                    com_ACC_ID_From.SelectedValue = -1;
                    com_ACC_Name_Form.SelectedIndex = -1;
        ...
        {
            com_ACC_ID_From.DataSource = dt_ACC;
            com_ACC_ID_From.SelectedValue = -1;
            com_ACC_Name_Form.DataSource = dt_ACC;
            com_ACC_Name_Form.SelectedValue = -1;
            com_Pay_Type.DataSource = Main.dt_Pay_Type;

            combo_CC1.SelectedValue = dr_Money_In["CC1_ID"];
            combo_CC2.SelectedValue = dr_Money_In["CC2_ID"];
            combo_Bill_User.SelectedValue = dr_Money_In["User_ID"];

            txt_Bill_ID.Text = dr_Money_In["Money_In_ID"].ToString();
            dtp_Money_In_Date.Value = Convert.ToDateTime(dr_Money_In["Money_In_Date"]);
            btn_Jor_No.Text = dr_Money_In["Jor_ID"].ToString();
            com_Pay_Type.SelectedValue = dr_Money_In["Pay_Type_ID"];

            txt_Notes.Text = dr_Money_In["Notes"].ToString();
            txt_Value.Text = dr_Money_In["Value"].ToString();
            com_ACC_ID_From.SelectedValue = dr_Money_In["ACC_ID"].ToString();

            if (dr_Money_In["Money_In_Date"] != DBNull.Value)
            {
                dtp_Money_In_Date.Value = Convert.ToDateTime(dr_Money_In["Money_In_Date"]);
                dtp_Money_In_Date.Checked = true;
                dtp_Money_In_Date.Format = DateTimePickerFormat.Short;
            }
            else
            {
                dtp_Money_In_Date.Checked = false;
                dtp_Money_In_Date.Format = DateTimePickerFormat.Custom;
            }
        ...
        #region Form
        private void FRM_Money_In_Enter(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in Main.dt_ACC.Rows)
            {
                if (dr["ACC_Proper_ID"].ToString() == "1")
                {
                    foreach (DataRow r in Main.dt_ACC.Rows)
                    {
                        ...
                        {
                            dt_ACC_Cust.Rows.Add(r.ItemArray);
                        }
                    }                 
                }
            }
        }
        private void FRM_Money_In_Shown(object sender, EventArgs e)
        {
        ...
        private void button_New_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString() == "New")
            {
                ...
                if(com_ACC_ID_From.SelectedValue == null)
                { MessageBox.Show("يجب تحديد الحساب"); com_ACC_Name_Form.Focus(); com_ACC_Name_Form.DroppedDown = true; return;}

                //insert into database   
                var();
                string t = Money_In.Insert();
                ...
                p1 = G.Select_LastBill(txt_Bill_ID.Text,14);
                foreach (DataRow r in p1.Rows)
                {
                    Main.dt_Money_In.Rows.Add(r.ItemArray);
                }

                // Reset Cursor Position
                n = Main.dt_Money_In.Rows.Count - 1;
                dr_Money_In = Main.dt_Money_In.Rows[n];
                Navigate();
                // Jor
                if (btn_Jor_No.Text != "")
                {
        ...
        private void button_Edit_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString() == "Edit")
            {
                ...
                Main.dt_Money_In.Rows.RemoveAt(n);

                // Insert Last Bill From DataBase To dt
                DataTable p1 = new DataTable();
                p1 = G.Select_LastBill(txt_Bill_ID.Text, 14);
                dr_Money_In = Main.dt_Money_In.NewRow();
                dr_Money_In.ItemArray = p1.Rows[0].ItemArray.Clone() as object[];
                Main.dt_Money_In.Rows.InsertAt(dr_Money_In, n);
        ...
        private void button_Cancel_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString() == "Edit")
            {
                ...
                DataRow dr;
                for (int i = 0; i < Main.dt_Money_In.Rows.Count; i++)
                {
                    dr = Main.dt_Money_In.Rows[i];
                    if (dr["ID"].ToString() == txt_Bill_ID.Text && dr["Branche_ID"].ToString() == combo_Bill_Branches.SelectedValue.ToString())
                    {
                        dr_Money_In = dr;
                    }
                }
                if (dr_Money_In == null) { return; }
        ...
        private void dateTimePicker_Money_In_Date_ValueChanged(object sender, EventArgs e)
        {
            dtp_Money_In_Date.Format = DateTimePickerFormat.Short;
        }
        ...
        private void comboBox_ACC_ID_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (com_ACC_ID_From.SelectedValue != null)
            {
                Main.dt_To_Store.DefaultView.RowFilter = string.Format("Branche_ID = " + com_ACC_ID_From.SelectedValue.ToString());
            }
        }
        private void checkBox_Ven_CheckedChanged(object sender, EventArgs e)
        {
            if (cbx_Cust.Checked == true)
            {
                com_ACC_ID_From.DataSource = dt_ACC_Cust;
                com_ACC_Name_Form.DataSource = dt_ACC_Cust;
            }
            else if (cbx_Cust.Checked == false)
            {
                com_ACC_ID_From.DataSource = dt_ACC;
                com_ACC_Name_Form.DataSource = dt_ACC;
            }
        ...
        {
            if (Main.dt_Money_In.Rows.Count == 0) { return; }
            nav = true;
            n = 0;

            do
            {
                if (n > Main.dt_Money_In.Rows.Count - 1) { n = 0; Form_Mode("Empty"); return; } // if there's no bills in this branche
                dr_Money_In = Main.dt_Money_In.Rows[n];
                n++;
            } while (dr_Money_In["Branche_ID"].ToString() != combo_Bill_Branches.SelectedValue.ToString());
        ...
        private void button_Last_Click(object sender, EventArgs e)
        {
            ...
            do
            {
                if (n < 0) { n = Main.dt_Money_In.Rows.Count - 1; Form_Mode("Empty"); return; }
                dr_Money_In = Main.dt_Money_In.Rows[n];
                n--;
            } while (dr_Money_In["Branche_ID"].ToString() != combo_Bill_Branches.SelectedValue.ToString());
        ...
        private void button_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                n++;
                if (n > Main.dt_Money_In.Rows.Count - 1) { n = last_n; return; }
                dr_Money_In = Main.dt_Money_In.Rows[n];
