...
{
    public partial class FRM_PurRe : Form
    {
        #region Declaration
        CLS_PurRe PurRe = new CLS_PurRe();
        Bills.FRM_Jor Jor;
        ...
        public FRM_PurRe(frm_Main main)
        {
            InitializeComponent();
            Main = main;
        ...
        void Set_default()
        {
            ...
            PurRe.Ven_ID = "";
            PurRe.PurRe_B_Type = 1;
            PurRe.PurRe_PurRe_No = "";
            PurRe.PurRe_Notes = "";
            PurRe.PurRe_Total = 0;
            PurRe.PurRe_Total_Dis_Rate = 0;
            PurRe.PurRe_Total_Dis_Value = 0;
            PurRe.PurRe_Net = 0;
            PurRe.PurRe_Total_SPrice = 0;
            if (PurRe.dt_Items != null) { PurRe.dt_Items.Clear(); }
            ...
            PurRe.Item_Dis_Value = 0;
            PurRe.Item_Dis_Rate = 0;
        }
        void Form_Mode(string mode)
        {
            switch (mode)
            {
                ...
                case "Select":
                    ...
                    Main.dt_IO.DefaultView.RowFilter = string.Format("Bill_ID ='" + txt_Bill_ID.Text + "' and Bill_Type = 8");
                    Other_Col();
        ...
        void Navigate()
        {
            ...
            txt_Bill_ID.Text = dr_Pur["PurRe_ID"].ToString();
            dtp_Pur_Date.Value = Convert.ToDateTime(dr_Pur["PurRe_Date"]);
            btn_Ref_No.Text = dr_Pur["Jor_ID"].ToString();
            com_B_Type.SelectedValue = dr_Pur["PurRe_B_Type"];
            txt_Pur_Pur_No.Text = dr_Pur["PurRe_PurRe_No"].ToString();

            if (dr_Pur["PurRe_PurRe_Date"] != DBNull.Value)
            {
                dtp_Pur_Pur_Date.Value = Convert.ToDateTime(dr_Pur["PurRe_PurRe_Date"]);
            ...
            txt_Notes.Text = dr_Pur["PurRe_Notes"].ToString();
            ...
            txt_Total_Pur_Price.Text = dr_Pur["PurRe_Total"].ToString();
            textBox_Total_Dis_Rate.Text = dr_Pur["PurRe_Total_Dis_Rate"].ToString();
            textBox_Total_Dis_Value.Text = dr_Pur["PurRe_Total_Dis_Value"].ToString();
            textBox_Net.Text = dr_Pur["PurRe_Net"].ToString();
            txt_Total_Sal_Price.Text = dr_Pur["PurRe_Total_SPrice"].ToString();
        ...
        void var()
        {
            PurRe.Branche_ID = com_Bill_Branches.SelectedValue.ToString();
            PurRe.Store_ID = Convert.ToInt32(com_Stores.SelectedValue);
            PurRe.CC1_ID = (com_CC1.SelectedValue == null) ? null : com_CC1.SelectedValue.ToString();
            PurRe.CC2_ID = (com_CC2.SelectedValue == null) ? null : com_CC2.SelectedValue.ToString();
            PurRe.Bill_ID = txt_Bill_ID.Text;
            PurRe.Ven_ID = (com_Ven_Name.SelectedValue != null) ? com_Ven_Name.SelectedValue.ToString() : null;
            PurRe.PurRe_B_Type = Convert.ToInt32(com_B_Type.SelectedValue);
            PurRe.PurRe_PurRe_No = txt_Pur_Pur_No.Text.ToString();

            if (dtp_Pur_Pur_Date.Checked == true)
            {
                PurRe.PurRe_PurRe_Date = dtp_Pur_Pur_Date.Value;
            }
            else
            {
                PurRe.PurRe_PurRe_Date = null;
            }

            PurRe.PurRe_Date = dtp_Pur_Date.Value;
            PurRe.PurRe_Notes = txt_Notes.Text.ToString();
            PurRe.Currency = Convert.ToInt16(com_Currency.SelectedValue);
            PurRe.Currency_Rate = Convert.ToDecimal(txt_Currency_Rate.Text);
            PurRe.PurRe_Total = Convert.ToDecimal(txt_Total_Pur_Price.Text);
            PurRe.PurRe_Total_Dis_Rate = (textBox_Total_Dis_Rate.Text != "." && textBox_Total_Dis_Rate.Text != "Rate") ? Math.Round(Convert.ToDecimal(textBox_Total_Dis_Rate.Text), 2) : 0;
            PurRe.PurRe_Total_Dis_Value = (textBox_Total_Dis_Value.Text != "." && textBox_Total_Dis_Value.Text != "Value") ? Math.Round(Convert.ToDecimal(textBox_Total_Dis_Value.Text), 2) : 0;
            PurRe.PurRe_Net = Convert.ToDecimal(textBox_Net.Text);
            PurRe.PurRe_Total_SPrice = Convert.ToDecimal(txt_Total_Sal_Price.Text);
            PurRe.User_ID = Convert.ToInt32(com_Bill_User.SelectedValue);
            PurRe.dt_Items = table();
        }
        void UpDowen()
        {
        ...
        private void button_New_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString() == "New")
            {
                ...
                // ADD  Bill From DataBase To Main.ds.Tables[36]
                DataTable p1 = new DataTable();
                p1 = G.Select_LastBill(t, 8);
                foreach (DataRow r in p1.Rows)
                {
                    Main.ds.Tables[36].Rows.Add(r.ItemArray);
                }
                // Add IO to Main.dt_IO
                DataTable p2 = new DataTable();
                p2 = G.Select_LastIO(t, 8);
                ...
                n = Main.ds.Tables[36].Rows.Count - 1;
                dr_Pur = Main.ds.Tables[36].Rows[n];
                Navigate();
        ...
        private void button_Edit_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString().ToString() == "Edit")
            {
                ...
                // Update database  
                var();
                string t = PurRe.Update();

                // Remove Old Bill From Datatable
                Main.ds.Tables[36].Rows.RemoveAt(n);
                // Remove Old IO
                for (int i = 0; i < Main.dt_IO.Rows.Count; i++)
                {
                    if (Main.dt_IO.Rows[i]["Bill_ID"].ToString() == txt_Bill_ID.Text && Main.dt_IO.Rows[i]["Bill_Type"].ToString() == "8")
                    {
                ...
                DataTable p1 = new DataTable();
                p1 = G.Select_LastBill(t, 8);
                dr_Pur = Main.ds.Tables[36].NewRow();
                dr_Pur.ItemArray = p1.Rows[0].ItemArray.Clone() as object[];
                Main.ds.Tables[36].Rows.InsertAt(dr_Pur, n);
                // Add IO
                DataTable p2 = new DataTable();
                p2 = G.Select_LastIO(t, 8);
                foreach (DataRow r in p2.Rows)
                ...
                {
                    if (r["Ref_NO"].ToString() == txt_Bill_ID.Text && Convert.ToInt16(r["Ref_Type"]) == 8)
                    { n_Jor = Main.dt_Jor.Rows.IndexOf(r); Main.dt_Jor.Rows.Remove(r); break; }
                }
                // Removr Old Jor_D
                for (int i = 0; i < Main.dt_Jor_D.Rows.Count; i++)
                {
                    if (Main.dt_Jor_D.Rows[i]["Ref_NO"].ToString() == txt_Bill_ID.Text && Convert.ToInt16(Main.dt_Jor_D.Rows[i]["Ref_Type"]) == 8)
                    {
        ...
        {
            if (Main.ds.Tables[36].Rows.Count == 0) { return; }
            nav = true;
            n = 0;
            do
            {
                if (n > Main.ds.Tables[36].Rows.Count - 1) { n = 0; Form_Mode("Empty"); return; }
                dr_Pur = Main.ds.Tables[36].Rows[n];
                n++;
        ...
        private void button_Last_Click(object sender, EventArgs e)
        {
            ...
            do
            {
                if (n < 0) { n = Main.ds.Tables[36].Rows.Count - 1; Form_Mode("Empty"); return; }
                dr_Pur = Main.ds.Tables[36].Rows[n];
                n--;
            } while (dr_Pur["Branche_ID"].ToString() != com_Bill_Branches.SelectedValue.ToString());
            n++;
        ...
        private void button_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                n++;
                if (n > Main.ds.Tables[36].Rows.Count - 1) { n = Main.ds.Tables[36].Rows.Count - 1; return; }
                dr_Pur = Main.ds.Tables[36].Rows[n];
        ...
        private void textBox_Search_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                DataRow dr;
                for (int i = 0; i < Main.ds.Tables[36].Rows.Count; i++)
                {
                    dr = Main.ds.Tables[36].Rows[i];
