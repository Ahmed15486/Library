...
{
    public partial class FRM_SalRe : Form
    {
        #region Declaration
        CLS_SalRe SalRe = new CLS_SalRe();
        Bills.FRM_Jor Jor;
        ...
        public FRM_SalRe(frm_Main main)
        {
            InitializeComponent();
            Main = main;
        ...
        void var()
        {
            SalRe.Bill_ID = txt_Bill_ID.Text;
            SalRe.Branche_ID = com_Bill_Branches.SelectedValue.ToString();
            SalRe.Store_ID = Convert.ToInt32(com_Stores.SelectedValue);
            SalRe.CC1_ID = (com_CC1.SelectedValue == null) ? null : com_CC1.SelectedValue.ToString();
            SalRe.CC2_ID = (com_CC2.SelectedValue == null) ? null : com_CC2.SelectedValue.ToString();
            SalRe.Cust_ID = (com_Cust_Name.SelectedValue != null) ? com_Cust_Name.SelectedValue.ToString() : null;
            SalRe.B_Type = Convert.ToInt32(com_B_Type.SelectedValue);

            SalRe.SalRe_Date = dtp_SalRe_Date.Value;
            SalRe.Notes = txt_Notes.Text.ToString();
            SalRe.Currency = Convert.ToInt16(com_Currency.SelectedValue);
            SalRe.Currency_Rate = Convert.ToDecimal(txt_Currency_Rate.Text);
            SalRe.Total = Convert.ToDecimal(txt_Total_SalRe_Price.Text);
            SalRe.Total_Dis_Rate = (textBox_Total_Dis_Rate.Text != "." && textBox_Total_Dis_Rate.Text != "Rate") ? Math.Round(Convert.ToDecimal(textBox_Total_Dis_Rate.Text), 2) : 0;
            SalRe.Total_Dis_Value = (textBox_Total_Dis_Value.Text != "." && textBox_Total_Dis_Value.Text != "Value") ? Math.Round(Convert.ToDecimal(textBox_Total_Dis_Value.Text), 2) : 0;
            SalRe.Net = Convert.ToDecimal(textBox_Net.Text);
            SalRe.Total_SP = Convert.ToDecimal(txt_Total_SalRe_Price.Text);
            SalRe.User_ID = Convert.ToInt32(com_Bill_User.SelectedValue);
            SalRe.dt_IO = table();
        }
        void Set_default()
        {
            ...
            SalRe.Notes = "";
            SalRe.Total = 0;
            SalRe.Total_Dis_Rate = 0;
            SalRe.Total_Dis_Value = 0;
            SalRe.Net = 0;
            SalRe.Total_SP = 0;
            if (SalRe.dt_IO != null) { SalRe.dt_IO.Clear(); }
        ...
        void Form_Mode(string mode)
        {
            switch (mode)
            {
                ...
                case "Select":
                    ...
                    Main.dt_IO.DefaultView.RowFilter = string.Format("Bill_ID ='" + txt_Bill_ID.Text + "' and Bill_Type = 12");
                    Other_Col();
                ...
                case "New":
                    ...
                    txt_Bill_ID.Clear();
                    dtp_SalRe_Date.Value = DateTime.Today;
                    dtp_SalRe_Date.Format = DateTimePickerFormat.Short;
                ...
                case "Empty":
                    ...
                    txt_Bill_ID.Clear();
                    dtp_SalRe_Date.Value = DateTime.Today;
                    dtp_SalRe_Date.Format = DateTimePickerFormat.Custom;
                    com_B_Type.SelectedIndex = 0;
                    dtp_SalRe_Date.Format = DateTimePickerFormat.Custom;
                    dtp_SalRe_Date.Checked = false;
                    txt_Notes.Clear();
        ...
        void Navigate()
        {
            ...
            com_Stores.SelectedValue = dr_SalRe["Store_ID"];
            com_CC1.SelectedValue = dr_SalRe["CC1_ID"];
            com_CC2.SelectedValue = dr_SalRe["CC2_ID"];
            com_Bill_User.SelectedValue = dr_SalRe["User_ID"];

            txt_Bill_ID.Text = dr_SalRe["SalRe_ID"].ToString();
            dtp_SalRe_Date.Value = Convert.ToDateTime(dr_SalRe["SalRe_Date"]);
            btn_Ref_No.Text = dr_SalRe["Jor_ID"].ToString();
            com_B_Type.SelectedValue = dr_SalRe["SalRe_B_Type"];

            if (dr_SalRe["SalRe_Date"] != DBNull.Value)
            {
                dtp_SalRe_Date.Value = Convert.ToDateTime(dr_SalRe["SalRe_Date"]);
                dtp_SalRe_Date.Checked = true;
                dtp_SalRe_Date.Format = DateTimePickerFormat.Short;
            }
            else
            {
            ...
            com_Currency.SelectedValue = dr_SalRe["Currency"];
            txt_Currency_Rate.Text = dr_SalRe["Currency_Rate"].ToString();
            txt_Notes.Text = dr_SalRe["SalRe_Notes"].ToString();
            com_Cust_Name.SelectedValue = dr_SalRe["Cust_ID"];
            txt_Total_SalRe_Price.Text = dr_SalRe["SalRe_Total"].ToString();
            textBox_Total_Dis_Rate.Text = dr_SalRe["SalRe_Total_Dis_Rate"].ToString();
            textBox_Total_Dis_Value.Text = dr_SalRe["SalRe_Total_Dis_Value"].ToString();
            textBox_Net.Text = dr_SalRe["SalRe_Net"].ToString();
        ...
        void Calc_Totals()
        {
            ...
            foreach (DataGridViewRow r in DGV.Rows)
            {
                ...
                txt_Total_SalRe_Price.Text = sp.ToString();
            }
        }
        void EmptyZero()
        {
        ...
        #region Form
        private void FRM_SalRe_Enter(object sender, EventArgs e)
        {
        ...
        private void FRM_SalRe_Shown(object sender, EventArgs e)
        {
        ...
        private void button_New_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString() == "New")
            {
                ...
                // Add Bill From DataBase To Main.ds.Tables[37]
                DataTable p1 = new DataTable();
                p1 = G.Select_LastBill(t, 12);
                foreach (DataRow r in p1.Rows)
                {
                    Main.ds.Tables[37].Rows.Add(r.ItemArray);
                }
                // Add IO to Main.dt_IO
                DataTable p2 = new DataTable();
                p2 = G.Select_LastIO(t, 12);
                ...
                n = Main.ds.Tables[37].Rows.Count - 1;
                dr_SalRe = Main.ds.Tables[37].Rows[n];
                Navigate();
        ...
        private void button_Edit_Click(object sender, EventArgs e)
        {
            ...
            else if (Tag.ToString().ToString() == "Edit")
            {
                // Update database  
                var();
                string t = SalRe.Update();

                // Remove Old Bill From Datatable
                Main.ds.Tables[37].Rows.RemoveAt(n);
                // Remove Old IO
                for (int i = 0; i < Main.dt_IO.Rows.Count; i++)
                {
                    if (Main.dt_IO.Rows[i]["Bill_ID"].ToString() == txt_Bill_ID.Text && Main.dt_IO.Rows[i]["Bill_Type"].ToString() == "12")
                    {
                        Main.dt_IO.Rows.RemoveAt(i);
                        i--;
                    }
                }
                // Insert Bill From DataBase To Main.ds.Tables[37]
                DataTable p1 = new DataTable();
                p1 = G.Select_LastBill(t, 12);
                dr_SalRe = Main.ds.Tables[37].NewRow();
                dr_SalRe.ItemArray = p1.Rows[0].ItemArray.Clone() as object[];
                Main.ds.Tables[37].Rows.InsertAt(dr_SalRe, n);
                // Add IO
                DataTable p2 = new DataTable();
                p2 = G.Select_LastIO(t, 12);
                foreach (DataRow r in p2.Rows)
        ...
        private void dateTimePicker_SalRe_Date_ValueChanged(object sender, EventArgs e)
        {
            dtp_SalRe_Date.Format = DateTimePickerFormat.Short;
        }
        #endregion
        ...
        private void DGV_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            if (Tag.ToString() != "Select" & txt_Barcode.Focused)
            {
                ...
                {
                    DGV.CurrentRow.Cells["Item_ID"].Value = dr_SalRe["Item_ID"].ToString();
                    DGV.CurrentRow.Cells["Item_Name"].Value = dr_SalRe["Item_ID"].ToString();
                    DGV.CurrentRow.Cells["Item_Quan"].Value = 1;
                    DGV.CurrentRow.Cells["Bonus"].Value = 0;
                    DGV.CurrentRow.Cells["Items_PPrice"].Value = dr_SalRe["PPrice"].ToString();
                    DGV.CurrentRow.Cells["Items_SPrice"].Value = dr_SalRe["SPrice"].ToString();
                    DGV.CurrentRow.Cells["Items_Total"].Value = dr_SalRe["PPrice"].ToString();
                    DGV.CurrentRow.Cells["Items_Dis_Rate"].Value = 0;
                    DGV.CurrentRow.Cells["Items_Dis_Value"].Value = 0;
                    DGV.CurrentRow.Cells["Total_PPrice"].Value = dr_SalRe["PPrice"].ToString();
                    Console.Beep();
                }
                else
                {
            ...
            else if (Tag.ToString() == "New" | Tag.ToString() == "Edit" && !button_Edit.Focused)
            {
                ...
                decimal sp = Math.Round(Convert.ToDecimal(txt_Total_SalRe_Price.Text), 2) + Convert.ToDecimal(DGV.Rows[e.RowIndex].Cells["Net"].Value);
                txt_Total_SalRe_Price.Text = sp.ToString();
            }
        ...
        {
            if (nav == true) { return; }
            decimal sp = Math.Round(Convert.ToDecimal(txt_Total_SalRe_Price.Text), 2) - Convert.ToDecimal(DGV.CurrentRow.Cells["Net"].Value);
            txt_Total_SalRe_Price.Text = sp.ToString();
        }
        ...
        #endregion
        private void textBox_Total_SalRe_Price_TextChanged(object sender, EventArgs e)
        {
            if (nav == true || skip_h == true) { return; }
            decimal total_pp = Convert.ToDecimal(txt_Total_SalRe_Price.Text);
        ...
        private void textBox_Total_Dis_Rate_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textBox_Total_Dis_Rate.Text != "Rate" && textBox_Total_Dis_Rate.Text != "" && textBox_Total_Dis_Rate.Text != ".")
            {
                ...
                {
                    textBox_Total_Dis_Value.Text = (Math.Round(((Convert.ToDecimal(textBox_Total_Dis_Rate.Text) / 100) * Convert.ToDecimal(txt_Total_SalRe_Price.Text)), 2)).ToString();
                    textBox_Total_Dis_Value.ForeColor = Color.Black;
                }
            }
            else
        ...
        private void textBox_Total_Dis_Value_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textBox_Total_Dis_Value.Text != "Value" & textBox_Total_Dis_Value.Text != "" & textBox_Total_Dis_Value.Text != ".")
            {
                ...
                if (!textBox_Total_Dis_Rate.Focused)
                {
                    ...
                    {
                        textBox_Total_Dis_Rate.Text = (Math.Round(((Convert.ToDecimal(textBox_Total_Dis_Value.Text) / Convert.ToDecimal(txt_Total_SalRe_Price.Text)) * 100), 2)).ToString();
                    }
                    textBox_Total_Dis_Rate.ForeColor = Color.Black;
                }
                textBox_Net.Text = (Math.Round(Convert.ToDecimal(txt_Total_SalRe_Price.Text) - Convert.ToDecimal(textBox_Total_Dis_Value.Text), 2)).ToString();
            }
            else
            {
                if (!textBox_Total_Dis_Rate.Focused)
                ...
                textBox_Net.Text = (Math.Round(Convert.ToDecimal(txt_Total_SalRe_Price.Text), 2)).ToString();
            }
        }
        ...
        {
            if (Main.ds.Tables[37].Rows.Count == 0) { return; }
            nav = true;
            n = 0;
            do
            {
                if (n > Main.ds.Tables[37].Rows.Count - 1) { n = 0; Form_Mode("Empty"); return; }
                dr_SalRe = Main.ds.Tables[37].Rows[n];
                n++;
            } while (dr_SalRe["Branche_ID"].ToString() != com_Bill_Branches.SelectedValue.ToString());
            n--;
            Navigate();
            nav = false;
        }
        private void button_Last_Click(object sender, EventArgs e)
        {
            ...
            do
            {
                if (n < 0) { n = Main.ds.Tables[37].Rows.Count - 1; Form_Mode("Empty"); return; }
                dr_SalRe = Main.ds.Tables[37].Rows[n];
                n--;
        ...
        private void button_Next_Click(object sender, EventArgs e)
        {
            ...
            {
                n++;
                if (n > Main.ds.Tables[37].Rows.Count - 1) { n = Main.ds.Tables[37].Rows.Count - 1; return; }
                dr_SalRe = Main.ds.Tables[37].Rows[n];
        ...
        private void textBox_Search_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                DataRow dr;
                for (int i = 0; i < Main.ds.Tables[37].Rows.Count; i++)
                {
                    dr = Main.ds.Tables[37].Rows[i];
