...
namespace Library.Bills
{
    public partial class FRM_Sal_Add : Form
    {
        ...
        private void com_Item_Name_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txt_Total.Text = (Math.Round(Convert.ToDecimal(txt_Quan.Text) * Convert.ToDecimal((txt_SPrice.Text) == "" ? "0" : txt_SPrice.Text), 2)).ToString();
        ...
        private void txt_Quan_TextChanged(object sender, EventArgs e)
        {
            ...
            txt_Total.Text = (Math.Round(Convert.ToDecimal(txt_Quan.Text) * Convert.ToDecimal(txt_SPrice.Text), 2)).ToString();
        }
        private void txt_Quan_Leave(object sender, EventArgs e)
        {
            ...
            if (txt_Quan.Text == "1") { txt_Total.Text = txt_SPrice.Text; }
        }
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("يجب تحديد سعر البيع", "! حقل فارغ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txt_SPrice.Text = "";
                txt_SPrice.Focus();
                return;
            }
